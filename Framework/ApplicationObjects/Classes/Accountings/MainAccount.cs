...
namespace NSites_V.ApplicationObjects.Classes.Accountings
{
    ...
    {
        #region "VARIABLES"
        //MainAccountDAO loMainAccountDAO;
        #endregion "END OF VARIABLES"

        #region "CONSTRUCTORS"
        public MainAccount()
        {
            //loMainAccountDAO = new MainAccountDAO();
        }
        ...
        public DataTable getAllData(string pDisplayType, string pPrimaryKey, string pSearchString)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getMainAccounts?pDisplayType=" + pDisplayType + "&pPrimaryKey=" + pPrimaryKey + "&pSearchString=" + pSearchString + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertMainAccount/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateMainAccount/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeMainAccount?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
