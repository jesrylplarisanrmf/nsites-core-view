...
namespace NSites_V.ApplicationObjects.Classes.Accountings
{
    ...
    {
        #region "VARIABLES"
        //SubClassificationDAO loSubClassificationDAO;
        #endregion "END OF VARIABLES"

        #region "CONSTRUCTORS"
        public SubClassification()
        {
           // loSubClassificationDAO = new SubClassificationDAO();
        }
        ...
        public DataTable getAllData(string pDisplayType, string pPrimaryKey, string pSearchString)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getSubClassifications?pDisplayType=" + pDisplayType + "&pPrimaryKey=" + pPrimaryKey + "&pSearchString=" + pSearchString + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertSubClassification/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateSubClassification/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeSubClassification?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
