...
namespace NSites_V.ApplicationObjects.Classes.Accountings
{
    ...
    {
        #region "VARIABLES"
        //ClassificationDAO loClassificationDAO;
        #endregion "END OF VARIABLES"

        #region "CONSTRUCTORS"
        public Classification()
        {
            //loClassificationDAO = new ClassificationDAO();
        }
        ...
        public DataTable getAllData(string pDisplayType, string pPrimaryKey, string pSearchString)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getClassifications?pDisplayType=" + pDisplayType + "&pPrimaryKey=" + pPrimaryKey + "&pSearchString=" + pSearchString + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertClassification/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateClassification/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeClassification?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
