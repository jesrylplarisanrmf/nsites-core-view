...
{
    public partial class SalesVoucherUI : Form
    {
        #region "VARIABLES"
        Customer loCustomer;
        ...
        public SalesVoucherUI(string pJournalEntryId)
        {
            InitializeComponent();
            loCustomer = new Customer();
        ...
        private void DividendJournalUI_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                ErrorMessageUI em = new ErrorMessageUI(ex.Message, this.Name, "DividendJournalUI_Load");
                em.ShowDialog();
                return;
            }
        }
